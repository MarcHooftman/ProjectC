...
const AdminLogin = () => {
  ...
  return (
    <Layout centered={true} role="admin-login-page">
        ...
        <Card.Body className="p-4 d-flex flex-column justify-content-center align-items-center">
          <Form className="d-flex flex-column gap-3" onSubmit={handleSubmit}>
            <Form.Group className="d-flex flex-column align-items-start w-100">
              <Form.Label htmlFor="admin-email" className="antes-secondary">
                E-mailadres
              </Form.Label>
              <Form.Control
                id="admin-email"
            ...
            <Form.Group className="d-flex flex-column align-items-start w-100">
              <Form.Label htmlFor="admin-password" className="antes-secondary">
                Wachtwoord
              </Form.Label>
              <Form.Control
                id="admin-password"
