      ...
      <h1 className="my-5 blue-text">Training Bewerken</h1>
        {<Card className="shadow-lg">
            <Card.Body>
              ...
              >
                <input placeholder="Titel" className="" onChange={onTitleChange} value={title}/>
                <TextInputWithCounter value={description} placeholder="Descriptie" maxLength={1000} onChange={onDescriptionChange} />
