        ...
        <Row>
          ...
          <Col md={6}>
            <div className="footer-links mt-3" role="footer-links">
              ...
              <Link to="https://www.anteszorg.nl/cookiemelding" target="_blank">
                Cookies
              </Link>
              <Link
                to="https://www.anteszorg.nl/hoe-wij-helpen/jouw-rechten/kwaliteitsstatuut"
                target="_blank"
              >
                Kwaliteitsstatuut
              </Link>
          ...
          <Col md={3}>
            <div className="footer-social gap-3 d-flex" role="social-links">
              ...
              <a
                href="https://www.linkedin.com/company/antes/"
                target="_blank"
                rel="noopener noreferrer"
              >
                <img
